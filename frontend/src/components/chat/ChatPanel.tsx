  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div
          className="border-t border-[var(--border)] p-4 flex-shrink-0"
        ...
        >
          <div className="flex items-center gap-2">
            <input
              ...
              disabled
              className="flex-1 px-4 py-2 border border-[var(--border)] rounded-lg bg-[var(--surface-elevated)] text-[var(--foreground-subtle)]"
            />
            <button
              type="button"
              disabled
              className="px-4 py-2 bg-[var(--surface-elevated)] text-[var(--foreground-subtle)] rounded-lg cursor-not-allowed"
            >
              Send
            </button>
          </div>
